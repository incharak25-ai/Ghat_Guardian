...
class RescueUnit(models.Model):
    ...
    name          = models.CharField(max_length=200)
    location      = models.PointField(geography=True)
    contact       = models.CharField(max_length=20, blank=True)   # SMS number e.g. +919876543210
    whatsapp      = models.CharField(max_length=20, blank=True)   # WhatsApp number
    avg_speed_kmh = models.FloatField(default=40)
